class ArticleTopic {
  constructor({
    ...
    if (articleUid) {
      this.articleUid = String(entityUid);
    }
   ...
   * topics_dpfs": Array[1][
   *        "tmrero-fr-alpha_tp11_fr|0.0488 tmrero-fr-alpha_tp32_fr|0.2631 tmrero-fr-alpha_tp33_fr|0.2155 tmrero-fr-alpha_tp42_fr|0.025 tmrero-fr-alpha_tp55_fr|0.3107 tmrero-fr-alpha_tp67_fr|0.025 "
   *    ],
