...
describe('\'embeddings\' service', () => {
  ...
  it('should not work (BadRequest) with multiple words', async () => service.find({
    query: {
      q: 'amour folie',
      language: 'fr',
    },
  ...
  it('should not work (NotFound) with words that do not exist in our embeddings', async () => service.find({
    query: {
      q: 'Vélozzome',
      language: 'fr',
    },
