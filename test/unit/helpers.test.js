...
import { toHierarchy, sliceAtSplitpoints, annotate, render, toExcerpt, latinise, toTextWrap } from '@/helpers.js'
...
describe('should cut a text around the annotation', () => {
  it('cut around Navin', () => {
    ...
    assert.strictEqual(
      ' Nechtssozialist Arthur <span class="highlight">Nozier</span> uuter den Auspizien des',
      toTextWrap({
        text,
        l: 73,
        r: 79,
